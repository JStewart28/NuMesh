...
| Conforming refinement | [tasks/conforming-refinement.md](tasks/conforming-refinement.md) | In progress (Tasks 1–2 of 8 done — mode plumbing, serial closure kernel; Task 3 next). Tasks 1–7 run no tests — Task 8 is the single verification pass. |
