...
| Conforming refinement | [tasks/conforming-refinement.md](tasks/conforming-refinement.md) | In progress (Tasks 1–5 of 8 done — mode plumbing, serial closure kernel, distributed split-edge discovery, distributed closure, migrate/loadBalance; Task 6 next). Tasks 1–7 run no tests — Task 8 is the single verification pass. |
